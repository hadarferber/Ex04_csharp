...
namespace Ex04.Menus.Test
{
    public class InterfaceMenuBuilder
    {
        ...
        public MenuItem BuildMainMenu()
        {
            ...
            timeDateMenu.AddSubMenuItem(new MenuItem("Show Current Date", new ShowDate(r_UsableMethods)));
            timeDateMenu.AddSubMenuItem(new MenuItem("Show Current Time", new ShowTime(r_UsableMethods)));
